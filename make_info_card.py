...
# ===========================================================================
HOST = "arya-chavan"   # shown as  arya-chavan@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "SOC Analyst · VAPT Analyst"),
    ("kv", "Prev", "CEH v13 candidate · MCA student"),
    ("kv", "Also", "Mumbai · 9552004409"),
    ("kv", "Edu", "MCA, St. Wilfred's College"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Tools", "Nmap, Wireshark, Burp, Metasploit"),
    ("kv", "Security", "Nessus, OpenVAS, Wazuh, SIEM"),
    ("kv", "OS", "Kali Linux, Ubuntu, Windows"),
    ("kv", "Code", "Python, HTML, CSS, JavaScript"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built a real-time SOC monitoring platform"),
    ("bul", "Created an API security scanner and phishing detector"),
]
